...
<body>
  ...
  <form id="gform" action="https://docs.google.com/forms/d/YOUR_GOOGLE_FORM_ID/formResponse](https://forms.gle/JHA68xMnLYVQAUcB9" method="POST" target="hidden_iframe" style="display:none;">
